...
def init_database_schema():
    ...
    with open(config.DATABASE_SCHEMA_PATH, "r") as f:
        create_table_sqls = f.read().split(";")
...
def init_database_data(start_date, end_date):
    ...
    # uploader._upload_stock_index_info(table_name=config.TABLE_STOCK_INDEX_INFO)
...
if __name__ == "__main__":
    ...
    # 插入数据
    init_database_data(start_date="20000101", end_date="20240101")
